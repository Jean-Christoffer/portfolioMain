...
Command: npx gltfjsx@6.2.3 public/models/room2.glb
*/
...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Plane001.geometry} material={materials['Mouse pad']} position={[-1.995, 3.2, 0.544]} />
      <mesh geometry={nodes.Cylinder007.geometry} material={materials.metal} position={[-1.964, 1.814, 0.537]} />
      <mesh geometry={nodes.Cylinder008.geometry} material={materials.metal} position={[-1.974, 0.495, 1.13]} rotation={[-1.024, 0.034, -0.005]} />
      <mesh geometry={nodes.Cylinder009.geometry} material={materials.metal} position={[-1.984, 0.229, 1.609]} rotation={[0, 0.768, -Math.PI / 2]} />
      <mesh geometry={nodes.Cylinder011.geometry} material={materials.metal} position={[-2.919, 0.229, 0.047]} rotation={[0, -1.121, -Math.PI / 2]} />
      <mesh geometry={nodes.Cylinder012.geometry} material={materials.metal} position={[-1.119, 0.229, -0.069]} rotation={[0, 0.616, -Math.PI / 2]} />
